...
- Generated: 2026-03-16T07:28:25.732929+00:00
- Tasks: 4
...
| `swarm` | 0% | 0.138 | 0.016 | 0.0 | 75% | 0.0000 |
...
| `auth_expiry_bug` | `swarm` | `lead_support` | 0.138 | 0% | 0.019 | 0 | no |
...
| `provider_compatibility_gap` | `swarm` | `parallel` | 0.138 | 0% | 0.014 | 0 | yes |
...
| `security_recovery` | `swarm` | `red_blue` | 0.138 | 0% | 0.017 | 0 | yes |
