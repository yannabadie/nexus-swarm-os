...
- Generated: 2026-03-16T11:18:03.579777+00:00
- Tasks: 4
...
| `swarm` | 0% | 0.154 | 13.115 | 0.0 | 50% | 0.0008 |
...
| `auth_expiry_bug` | `swarm` | `lead_support` | 0.138 | 0% | 0.016 | 0 | no |
...
| `memory_storage_contradiction` | `swarm` | `red_blue` | 0.138 | 0% | 0.016 | 0 | yes |
...
| `provider_compatibility_gap` | `swarm` | `parallel` | 0.204 | 0% | 52.414 | 0 | no |
...
| `security_recovery` | `swarm` | `red_blue` | 0.138 | 0% | 0.014 | 0 | yes |
...
- Best average score in this run: `deterministic_pipeline` (0.671).
